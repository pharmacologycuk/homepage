...
데이터 과학을 사용한 의학 자료 분석의 중요성이 날로 커지고 있다. 약리학 교과목에서 학습한 약동학 이론을 활용하는 방법을 예시를 통해 구체적으로 학습한다. 특히, 임상시험 자료의 변형 및 분석을 통하여 신약 개발 분야에서 의사결정에 임상약동학이 어떻게 사용되는지 파악한다. 모든 과정은 동영상 1시간 시청 후 Zoom에서 정해진 시간에 만나 1시간 토론하는 형태의 비대면 flipped learning을 지향하며 https://github.com/pipetcpt/trainees 에 모든 자료가 공개되어 있다.
