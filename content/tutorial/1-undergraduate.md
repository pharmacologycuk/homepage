...
데이터 과학을 사용학 의학 자료 분석의 중요성이 날로 커지고 있다. 약리학 교과목에서 학습한 약동학 이론을 활용하는 방법을 예시를 통해 구체적으로 학습한다. 특히, 임상시험 자료의 변형 및 분석을 통하여 신약 개발 분야에서 의사결정에 임상약동학이 어떻게 사용되는지 파악한다. 모든 과정은 동영상 1시간 시청 후 Zoom에서 정해진 시간에 만나 1시간 토론하는 형태의 비대면 flipped learning을 지향하며 https://github.com/pipetcpt/trainees 에 모든 자료가 공개되어 있다.

**학습목표**

1. 약동학의 기본 개념을 설명할 수 있다.
1. 약동학 분석을 위한 자료를 이해하고 생성할 수 있다.
1. 비구획 분석 및 구획 분석을 수행하고 기초적인 모델을 구성할 수 있다.
1. 데이터 과학을 학습하여 관련 자료를 이해하고 실제 업무 종사자와 의사소통을 할 수 있다.
1. R을 통한 데이터 과학 기법을 익히고, 기초 의학 통계 분석을 수행할 수 있다.

번호 | 참여(담당)교수 | 수업명(수업제목) | 수업속성
-- | -- | -- | --
1 | 임동석 | 강의 소개 및 관련 실습 환경 설정 | 선택과정
2 | 한승훈 | 약동학 이론의 복습 | 선택과정
3 | 한승훈 | 임상약동학의 이론과 활용 예 | 선택과정
4 | 한성필 | 데이터 과학 실습 도구(R. Git)에 대한 설명 | 선택과정
5 | 한성필 | 약동학 자료 생성 및 비구획 분석 실습 | 선택과정
6 | 한성필 | 약동학 자료 생성 및 구획 분석 실습 | 선택과정
